...
class FirstScene extends Phaser.Scene {
  ...
  bgAndHeading() {
    ...
    this.headingText = this.add
      .text(
        this.width / 2,
        this.height * 0.165,
        "How many charges need to\nspin this motor 100 times? Let's Spin.",
        {
          fontSize: "24px",
          fill: "#ffffff",
  ...
  chargeAble() {
    if (this.chargeCount < 1) {
      this.headingText.setText(
        "One of the battery charge has finished.\nYou have to charge to spin the motor again."
      );
    } else {
      this.headingText.setText("Charge again.");
    }
  ...
  chargeComplete() {
    this.headingText.setText("Charge completed.\nSpin again");
  ...
  firstSceneComplete() {
    ...
    this.nextButtonText = this.add
      .text(this.width * 0.5, this.height * 0.89, "NEXT CONDITION", {
        fontSize: "17px",
        fill: "#ffffff",
        fontFamily: "Microsoft Sans Serif",
        fontStyle: "bold",
